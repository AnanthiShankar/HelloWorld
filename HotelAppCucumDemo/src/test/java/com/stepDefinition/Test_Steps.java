...
public class Test_Steps {
	...
	public void the_book_a_hotel_page_is_displayed() {
	  ...
	  @When("User enters the username {string} details") 
	  public void user_enters_the_username_details(String string) {
		  // Write code here that turns the phrase above into concrete actions 
		  WebElement  uname=driver.findElement(By.id("username")); uname.clear();
	  uname.sendKeys(string);
	  }
	  
	  @When("User enters the password {string} details")
	  public void user_enters_the_password_details(String string) { 
	  // Write code here that  turns the phrase above into concrete actions
	  driver.findElement(By.name("password")).clear();
